...
export const TROPHIES: TrophyDef[] = [
  ...
  {
    id: 'near_miss_25',
    nameKey: 'trophies.near_miss_25',
    descriptionKey: 'trophies.near_miss_25_desc',
    tier: 'bronze',
    icon: 'gps_fixed',
    order: 8,
    predicate: (s) => s.lifetimeStats.totalNearMisses >= 25,
  },
  {
    id: 'high_score_1000',
  ...
  {
    id: 'near_miss_50',
    nameKey: 'trophies.near_miss_50',
    descriptionKey: 'trophies.near_miss_50_desc',
    tier: 'prata',
    icon: 'track_changes',
    order: 16,
    predicate: (s) => s.lifetimeStats.totalNearMisses >= 50,
  },
  {
    id: 'coins_2500',
  ...
  {
    id: 'near_miss_75',
    nameKey: 'trophies.near_miss_75',
    descriptionKey: 'trophies.near_miss_75_desc',
    tier: 'ouro',
    icon: 'crisis_alert',
    order: 24,
    predicate: (s) => s.lifetimeStats.totalNearMisses >= 75,
  },
  {
    id: 'high_score_25000',
  ...
  {
    id: 'near_miss_150',
    nameKey: 'trophies.near_miss_150',
    descriptionKey: 'trophies.near_miss_150_desc',
    tier: 'elite',
    icon: 'radar',
    order: 33,
    predicate: (s) => s.lifetimeStats.totalNearMisses >= 150,
  },
  {
    id: 'games_250',
