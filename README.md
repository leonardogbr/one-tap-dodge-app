...
Hyper-casual mobile game: tap to swap lanes, dodge obstacles, survive. Built with React Native (TypeScript), bare RN.

**Phase 1 (current):** Core gameplay — tap to start, tap to swap lanes; obstacles fall; collision = game over; near-miss bonus; score increases over time.

## Run the app

```sh
npm start          # Metro bundler
npm run android    # Android (with emulator or device)
